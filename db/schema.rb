...
ActiveRecord::Schema[7.0].define(version: 2022_11_24_141646) do
  ...
  create_table "chats", charset: "latin1", force: :cascade do |t|
    ...
    t.index ["identifier_number"], name: "index_chats_on_identifier_number"
  end
  ...
  create_table "messages", charset: "latin1", force: :cascade do |t|
    ...
    t.index ["identifier_number"], name: "index_messages_on_identifier_number"
  end
